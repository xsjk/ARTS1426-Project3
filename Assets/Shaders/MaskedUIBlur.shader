        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                half4 frag(v2f i) : COLOR
                {
                    ...
                    for (int k = -4; k <= 4; k++)
                    {
                        sum += tex2Dproj(_HBlur, UNITY_PROJ_COORD(float4(i.uvgrab.x + _HBlur_TexelSize.x * k * _Size * 0.5, i.uvgrab.y, i.uvgrab.z, i.uvgrab.w))) * weight[abs(k)];
                    }
            ...
            Pass
            {
                ...
                half4 frag(v2f i) : COLOR
                {
                    ...
                    for (int k = -4; k <= 4; k++)
                    {
                        sum += tex2Dproj(_VBlur, UNITY_PROJ_COORD(float4(i.uvgrab.x, i.uvgrab.y + _VBlur_TexelSize.y * k * _Size * 0.5, i.uvgrab.z, i.uvgrab.w))) * weight[abs(k)];
                    }
